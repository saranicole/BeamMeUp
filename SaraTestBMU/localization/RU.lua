...
-- SETTINGS
-----------------------------------------------------------------------------
mkstr(SI.TELE_SETTINGS_TOGGLE_DISCOVERY, "Включите обнаружение святилищ в режиме случайного выбора"),
...
mkstr(SI.TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION0, "Гильдии за гильдиями")
