...
-- SETTINGS
-----------------------------------------------------------------------------
mkstr(SI.TELE_SETTINGS_TOGGLE_DISCOVERY, "Attiva la scoperta di Wayshrine in modalità casuale"),
...
mkstr(SI.TELE_KEYBINDING_WAYSHRINE_FAVORITE, "Wayshrine Favorite")
    ...
    ["SI_TELE_DIALOG_AUTO_UNLOCK_BODY"] = "Confermando, BeamMeUp inizierà a viaggiare verso tutti i giocatori disponibili nella zona corrente. In questo modo, salterai automaticamente da un santuario all'altro per sbloccare il maggior numero possibile di oggetti.",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_LOOP_OPTION"] = "Looping sulle zone ...",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION0"] = "Gilda per gilda",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION1"] = "mescolare in modo casuale",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION2"] = "in base al rapporto dei santuari non scoperti",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION3"] = "per numero di giocatori",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION4"] = "per nome della zona",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_CHAT_LOG_OPTION"] = "Risultati di output nella chat",
